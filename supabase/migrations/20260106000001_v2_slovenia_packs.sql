...
INSERT INTO public.packs (id, owner_user_id, name, description, is_system, country_code, tags, business_types) VALUES
  (
    'si000001-0000-0000-0000-000000000000',
    null,
...
INSERT INTO public.packs (id, owner_user_id, name, description, is_system, country_code, tags, business_types) VALUES
  (
    'si000002-0000-0000-0000-000000000000',
    null,
...
INSERT INTO public.tasks (id, platform_id, title, why_text, instructions_md, is_blocking, proof_type, requires_verification, platform_tag) VALUES
  (
    'si200000-0000-0000-0000-000000000001',
  ...
  (
    'si200000-0000-0000-0000-000000000002',
    'banksi00-0000-0000-0000-000000000000',
  ...
  (
    'si200000-0000-0000-0000-000000000003',
    'edavki00-0000-0000-0000-000000000000',
  ...
  (
    'si200000-0000-0000-0000-000000000004',
    'edavki00-0000-0000-0000-000000000000',
  ...
  (
    'si200000-0000-0000-0000-000000000005',
    'edavki00-0000-0000-0000-000000000000',
...
INSERT INTO public.pack_tasks (pack_id, task_id, sort_order) VALUES
  ('si000002-0000-0000-0000-000000000000', 'si200000-0000-0000-0000-000000000001', 1),
  ('si000002-0000-0000-0000-000000000000', 'si200000-0000-0000-0000-000000000002', 2),
  ('si000002-0000-0000-0000-000000000000', 'si200000-0000-0000-0000-000000000003', 3),
  ('si000002-0000-0000-0000-000000000000', 'si200000-0000-0000-0000-000000000004', 4),
  ('si000002-0000-0000-0000-000000000000', 'si200000-0000-0000-0000-000000000005', 5)
ON CONFLICT DO NOTHING;
...
INSERT INTO public.packs (id, owner_user_id, name, description, is_system, country_code, tags, business_types) VALUES
  (
    'si000003-0000-0000-0000-000000000000',
    null,
...
INSERT INTO public.tasks (id, platform_id, title, why_text, instructions_md, is_blocking, proof_type, requires_verification, platform_tag) VALUES
  (
    'si300000-0000-0000-0000-000000000001',
    'ajpes000-0000-0000-0000-000000000000',
  ...
  (
    'si300000-0000-0000-0000-000000000002',
    'edavki00-0000-0000-0000-000000000000',
  ...
  (
    'si300000-0000-0000-0000-000000000003',
    'banksi00-0000-0000-0000-000000000000',
  ...
  (
    'si300000-0000-0000-0000-000000000004',
    'edavki00-0000-0000-0000-000000000000',
  ...
  (
    'si300000-0000-0000-0000-000000000005',
    'ajpes000-0000-0000-0000-000000000000',
...
INSERT INTO public.pack_tasks (pack_id, task_id, sort_order) VALUES
  ('si000003-0000-0000-0000-000000000000', 'si300000-0000-0000-0000-000000000001', 1),
  ('si000003-0000-0000-0000-000000000000', 'si300000-0000-0000-0000-000000000002', 2),
  ('si000003-0000-0000-0000-000000000000', 'si300000-0000-0000-0000-000000000003', 3),
  ('si000003-0000-0000-0000-000000000000', 'si300000-0000-0000-0000-000000000004', 4),
  ('si000003-0000-0000-0000-000000000000', 'si300000-0000-0000-0000-000000000005', 5)
ON CONFLICT DO NOTHING;
...
INSERT INTO public.packs (id, owner_user_id, name, description, is_system, country_code, tags, business_types) VALUES
  (
    'si000004-0000-0000-0000-000000000000',
    null,
...
INSERT INTO public.tasks (id, platform_id, title, why_text, instructions_md, is_blocking, proof_type, requires_verification, platform_tag) VALUES
  (
    'si400000-0000-0000-0000-000000000001',
    'edavki00-0000-0000-0000-000000000000',
  ...
  (
    'si400000-0000-0000-0000-000000000002',
    'edavki00-0000-0000-0000-000000000000',
  ...
  (
    'si400000-0000-0000-0000-000000000003',
    'edavki00-0000-0000-0000-000000000000',
    'Prenos podatkov o zaposlenEvidenca zaposlenih (če obstaja)',
...
INSERT INTO public.pack_tasks (pack_id, task_id, sort_order) VALUES
  ('si000004-0000-0000-0000-000000000000', 'si400000-0000-0000-0000-000000000001', 1),
  ('si000004-0000-0000-0000-000000000000', 'si400000-0000-0000-0000-000000000002', 2),
  ('si000004-0000-0000-0000-000000000000', 'si400000-0000-0000-0000-000000000003', 3)
ON CONFLICT DO NOTHING;
...
INSERT INTO public.packs (id, owner_user_id, name, description, is_system, country_code, tags, business_types) VALUES
  (
    'si000005-0000-0000-0000-000000000000',
    null,
...
INSERT INTO public.tasks (id, platform_id, title, why_text, instructions_md, is_blocking, proof_type, requires_verification, platform_tag) VALUES
  (
    'si500000-0000-0000-0000-000000000001',
    'edavki00-0000-0000-0000-000000000000',
    'Potrditev DDV obveznosti',
  ...
  (
    'si500000-0000-0000-0000-000000000002',
    'edavki00-0000-0000-0000-000000000000',
  ...
  (
    'si500000-0000-0000-0000-000000000003',
    'edavki00-0000-0000-0000-000000000000',
...
INSERT INTO public.pack_tasks (pack_id, task_id, sort_order) VALUES
  ('si000005-0000-0000-0000-000000000000', 'si500000-0000-0000-0000-000000000001', 1),
  ('si000005-0000-0000-0000-000000000000', 'si500000-0000-0000-0000-000000000002', 2),
  ('si000005-0000-0000-0000-000000000000', 'si500000-0000-0000-0000-000000000003', 3)
ON CONFLICT DO NOTHING;

...
INSERT INTO public.platforms (id, key, name) VALUES
  ('eda00000-0000-0000-0000-000000000001', 'edavki', 'eDavki'),
  ('a1000000-0000-0000-0000-000000000002', 'ajpes', 'AJPES'),
  ('ba000000-0000-0000-0000-000000000003', 'bank_si', 'Slovenska Banka'),
  ('f0000000-0000-0000-0000-000000000004', 'furs', 'FURS')
